...
def searchingRefSeq(
    ...
    if not log :
        log = open("~/Documents/OceanView/VIMVer/VIMVer/VIMVer/file/InstantFinder/log.txt",'w')
...
#dictToFile(searchingRefSeq(), testpath="/home/vincentwilde/Documents/VIMVer/VIMVer/VIMVer/file/dataBase_local/")