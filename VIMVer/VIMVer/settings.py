"""
Django settings for VIMVer project.
...
INSTALLED_APPS = [
    'InstantViewer.apps.InstantviewerConfig',
    'InstantFinder.apps.InstantfinderConfig',
...
WSGI_APPLICATION = 'VIMVer.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = (
    path.join(BASE_DIR, 'VIMVer', 'static'),
)
...
MEDIA_URL = 'file/'
MEDIA_ROOT = path.join(BASE_DIR, 'VIMVer', 'file')


# ./VIMVer/files/dataBase_local/
