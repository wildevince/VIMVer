...
CREATE TABLE CAZy_DB (
  DB_ac int not null auto_increment default 1,  -- id
  ...
  Tax_id int(11) default NULL,  -- FK
  EC varchar(100) default NULL,  -- FK
...
CREATE TABLE EC_num (
  EC varchar(16) NOT NULL default '',  -- id
...
CREATE TABLE Cz_EC (
  DB_ac int(10) NOT NULL default '0',  -- FK
  EC varchar(16) NOT NULL default '',  -- FK
...
CREATE TABLE Fam_biblio (
  Family varchar(5) NOT NULL default '',  -- FK
  Id_Biblio int(11) NOT NULL default '0',  -- id
...
CREATE TABLE ModO_Composition (
  DB_ac int(11) NOT NULL default 0,  -- FK
  Mod_num int(11) NOT NULL AUTO_INCREMENT default 1,  -- id
  Family varchar(10) NOT NULL default '',  -- FK
...
CREATE TABLE ModO_CrossRefs (
  Family varchar(10) NOT NULL default '',  -- FK
  Link varchar(100) NOT NULL default '',  -- id?
...
CREATE TABLE ModO_Families (
  Family varchar(10) UNIQUE NOT NULL default '',  -- id
...
CREATE TABLE ModO_Limits (
  DB_ac int(11) NOT NULL default '0',  -- FK
  Mod_num int(11) NOT NULL default '0',  -- FK
 ...
 --  [data]
CREATE TABLE Motifs (
  motifs_ac int not null auto_increment default 1,  -- id
...
CREATE TABLE Organism (
  Tax_id varchar(10) UNIQUE NOT NULL default '',  -- id
  Name text NOT NULL,
  Categorie varchar(30) default NULL,
  Classe longtext,
  Ordre varchar(30) default NULL,
  Fam varchar(30) default NULL,  -- FK
...
CREATE TABLE Prot_MOTIF (
  ...
  MOTIF_ac int(11) NOT NULL default '0',  -- FK
